...
async def main():
    ...
    try:
        ...
        base_deposit_amount = Decimal(os.getenv("BASE_DEPOSIT_AMOUNT", "1000"))  # Default: 100 base tokens
        quote_deposit_amount = Decimal(os.getenv("QUOTE_DEPOSIT_AMOUNT", "40"))  # Default: 1000 quote tokens
